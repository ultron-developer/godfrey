...
<body>
    <div class="container mt-3">
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-3">
                    <h6 class="my-2">Regular</h6>
                    <p class="mb-1"><?php echo $data["gas_$"]; ?></p>
                    <p class="mb-1"><?php echo $data["gas_L"]; ?></p>
                </div>
                <div class="col-3">
        ...
        <div class="container text-center">
            <form action="controllers/fuel_controller.php" method="post">
                <input type="hidden" name="action" value="new_dayEndConfirmation">
