    ...
    <div class="container mt-3">
        ...
        <div class="container">
            <form action="controllers/fuel_controller.php" method="post">
                <input type="hidden" name="action" value="dailyCalculation_new">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroupPrepend3">Regular</span>
                            </div>
                            <input type="number" name="gas_$" step="0.01" class="form-control" id="" placeholder="$" aria-describedby="inputGroupPrepend3" value="<?php echo isset($_SESSION['dailyCalculation']) ? $_SESSION['dailyCalculation']['gas_$'] : ""; ?>" required>
                            <input type="number" name="gas_L" step="0.001" class="form-control" id="" placeholder="Liters" aria-describedby="inputGroupPrepend3" value="<?php echo isset($_SESSION['dailyCalculation']) ? $_SESSION['dailyCalculation']['gas_L'] : ""; ?>" required>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="input-group">
